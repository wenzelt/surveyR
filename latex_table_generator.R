...
print(xtable(Usage_CCR_LATEX, type = "latex",caption = "dunnTest comparison results for the usage of Smart Home Devices Overall by Region of Residence"), file = "latex_tables/USAGE_CCR_OVERALL.tex")

# export Usage x CCR Latex Smart TV
print(xtable(Usage_CCR_LATEX_SMART_TV, type = "latex",caption = "dunnTest comparison results for the usage of Smart TV's by Region of Residence"), file = "latex_tables/USAGE_CCR_SMART_TV.tex")

# export Usage x CCR Latex Smart Speaker
print(xtable(Usage_CCR_LATEX_SMART_SPEAKER, type = "latex",caption = "dunnTest comparison results for the usage of Smart Speakers by Region of Residence"), file = "latex_tables/USAGE_CCR_SMART_SPEAKER.tex")

# export Usage x CCR Latex Smart Lightbulb
print(xtable(Usage_CCR_LATEX_SMART_LIGHTBULB, type = "latex",caption = "dunnTest comparison results for the usage of Smart Lightbulbs Overall by Region of Residence"), file = "latex_tables/USAGE_CCR_SMART_LIGHTBULB.tex")

# export Usage x CCR Latex Other Devices
print(xtable(Usage_CCR_LATEX_OTHER, type = "latex",caption = "dunnTest comparison results for the usage of Smart Lightbulbs Overall by Region of Residence"), file = "latex_tables/USAGE_CCR_OTHER.tex")

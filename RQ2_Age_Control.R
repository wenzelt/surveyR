...
#not significant by correlation 
cor.test(as.numeric(d$Usage),d$Age)
plot(as.numeric(d$Usage),d$Age)
...
Usage_CCR_LATEX_SMART_TV <-
  dunnTest(
    ...
    g = as.factor(subset(d, Device == "Smart TV")$Age),
    method = "bonferroni"
  )$res

#Cor test for devices 
cor.test(as.numeric(subset(d, Device == "Smart TV")$Usage),subset(d, Device == "Smart TV")$Age )
cor.test(as.numeric(subset(d, Device == "Smart Speaker")$Usage),subset(d, Device == "Smart Speaker")$Age )
cor.test(as.numeric(subset(d, Device == "Smart Lightbulb")$Usage),subset(d, Device == "Smart Lightbulb")$Age )


Usage_CCR_LATEX_SMART_TV <- Usage_CCR_LATEX_SMART_TV[-c(3)]
aggregate(as.numeric(subset(d, Device == "Smart TV")$Usage), list(as.factor(
  subset(d, Device == "Smart TV")$Age
)), mean)
...
Usage_CCR_LATEX_SMART_SPEAKER <-
  dunnTest(
    ...
    g = as.factor(
      subset(d, Device == "Smart Speaker")$Age
    ),
    method = "bonferroni"
  )$res
...
Usage_CCR_LATEX_SMART_LIGHTBULB <-
  dunnTest(
    ...
    g = as.factor(
      subset(d, Device == "Smart Lightbulb")$Age
    ),
    method = "bonferroni"
  )$res
...
cor.test(singleSourceOfTruthAppended$E201_11,singleSourceOfTruthAppended$age)
cor.test(singleSourceOfTruthAppended$E201_14,singleSourceOfTruthAppended$age)
cor.test(singleSourceOfTruthAppended$E201_16,singleSourceOfTruthAppended$age)
# no correlation between device risk and age 
